...
\node[pin={[pin distance=0.2cm]10:{\tiny 5s$_{1/2}^{-1}$}}]
     at (axis cs:4.6,0.8) {};
\node[pin={[pin distance=0.2cm]170:{\tiny 4p$_{3/2}^{-1}$}}]
     at (axis cs:28.9,0.6) {};
\node[pin={[pin distance=0.2cm]10:{\tiny 4p$_{1/2}^{-1}$}}]
     at (axis cs:27.89,0.6) {};
\node[pin={[pin distance=0.2cm]10:{\tiny 4s$_{1/2}^{-1}$}}]
     at (axis cs:46.5,0.4) {};
\node[pin={[pin distance=0.2cm]190:{\tiny 5s$_{1/2}^{-2}$}}]
     at (axis cs:17.0,-0.7) {};
